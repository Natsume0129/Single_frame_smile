# extract_features_resnet18.py
# Read .dat (rel_path label), ignore label; output .npz with paths + feats (N x 512)
...
# ========== Config ==========
ROOT_DIR = r"E:\Single_frame_smile\data\Isornot"   # where "images/..." lives
DAT_FILE = r"E:\Single_frame_smile\data\Isornot\matched.dat"
OUT_FILE = r"E:\Single_frame_smile\data\Isornot\features\resnet18_matched_features.npz"


BATCH_SIZE = 64
NUM_WORKERS = 0  # Windows-safe
USE_AMP = True   # optional speedup on modern GPUs
...
class DatDataset(Dataset):
    ...
    def __getitem__(self, idx: int):
        ...
        return img, rel_path, y  # y returned for convenience; you can ignore later
...
def build_resnet18_feature_extractor(device: torch.device) -> torch.nn.Module:
    m = models.resnet18(weights=models.ResNet18_Weights.IMAGENET1K_V1)
    m.fc = torch.nn.Identity()  # output: (B, 512)
    m.eval()
...
def main():
    ...
    feats_mat = np.concatenate(all_feats, axis=0)  # (N, 512)
